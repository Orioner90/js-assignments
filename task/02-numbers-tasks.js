...
function getCicleCircumference(radius) {
	if(Number.isInteger(radius)) return (2 * Math.PI * radius).toPrecision(16);
	else return (2 * Math.PI * radius).toPrecision(17);    
}
...
function getAverage(value1, value2) {
	...
	var result=((value1+value2)/2).toString();
	if(result=="Infinity") return maxNum.toString();	
...
value=+value;
if(typeof value=="number"&& value.toString()!=Number.NaN.toString())
{ return value;}
else{return def;}   
}
